# Generated by Django 2.2.5 on 2019-09-28 23:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('edited_date', models.DateTimeField(
                    default=django.utils.timezone.now)),
                ('MeteorologicalStation', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING,
                                                            to='stations.MeteorologicalStation', verbose_name='Estação Meteorológica')),
            ],
        ),
    ]
